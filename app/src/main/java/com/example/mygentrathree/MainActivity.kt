...
class MainActivity : AppCompatActivity(), UserLocationObjectListener, CameraListener {
    ...
    private lateinit var btnMapMode: ImageView   // Түнгі/Күндізгі режим түймесі
    ...
    private fun setupListeners() {
        // Карта режимін (Түн/Күн) ауыстыру түймесі
    ...
    private fun applyMapMode() {
        ...
        btnMapMode.setColorFilter(ContextCompat.getColor(this, color))
    }
